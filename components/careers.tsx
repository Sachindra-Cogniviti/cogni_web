import { Container, Kicker, outlineButton, Roll } from "@/components/primitives"
...
export function Careers() {
  return (
    <section id="careers" className="relative py-[clamp(72px,8vw,110px)]">
